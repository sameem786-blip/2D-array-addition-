const cal = () => {
    ...
    document.getElementById("m3_r1c3").value = m3[0][2];
    document.getElementById("m3_r2c1").value = m3[1][0];
    document.getElementById("m3_r2c2").value = m3[1][1];
    document.getElementById("m3_r2c3").value = m3[1][2];
    document.getElementById("m3_r3c1").value = m3[2][0];
    document.getElementById("m3_r3c2").value = m3[2][1];
